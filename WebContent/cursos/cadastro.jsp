          ...
          <div class="col-md-12">
            <form class="form-horizontal" role="form"  action="http://localhost/ProjetoWeb/Controlador" method="post">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="number" name="cdCurso" class="form-control" id="inputCURSO" placeholder="Curso" maxlength="10" required>
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-2">
                ...
                <div class="col-sm-10">
                  <input type="text" name="nome" class="form-control" id="inputNome" placeholder="Nome" maxlength="40" required>
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-2">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="url" name="site" class="form-control" id="inputSITE" placeholder="Site" maxlength="40" required>
                </div>
              </div>
