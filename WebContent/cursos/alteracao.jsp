...
<body>
	...
	<div class="section">
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center">
					<h3 class="tt_menu">&gt;&gt; CURSOS - ALTERAR UM CURSO
						&lt;&lt;</h3>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<form class="form-horizontal" role="form"  action="http://localhost/ProjetoWeb/Controlador" method="post">
						<div class="form-group">
							...
							<div class="col-sm-10">
							<input type="number" name="cdCurso"
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="nome" maxlength="40"
									class="form-control" id="inputNome" placeholder="Nome" required>
							</div>
						</div>
						<div class="form-group">
							<div class="col-sm-2">
							...
							<div class="col-sm-10">
								<input type="number" name="valor" maxlength="15"
									Fpattern="([0-9]{1,3}\.)?[0-9]{1,3},[0-9]{2}$"
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="url" name="site" maxlength="40"
									class="form-control" id="inputSITE" placeholder="Site" required>
							</div>
						</div>
