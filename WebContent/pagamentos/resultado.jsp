...
<body>
			...
			<div class="row text-center">
				<div class="col-md-12 text-center">
					...
					<c:if test="${pagamento != null}">
						...
						<h3 class="text-center">Codigo Curso:${pagamento.id.cdCurso}</h3>
						<h3 class="text-center">Data Inscricao:${pagamento.dataInscricao}</h3>						
					</c:if>
				</div>
			</div>
		</div>
	...
	<div class="section">
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center">
					<a class="btn btn-danger" href="index.jsp">Retornar ao Menu Pagamento</a>
				</div>
			</div>
		</div>
	</div>
