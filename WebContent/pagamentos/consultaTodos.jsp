...
<Title>Consulta Todos Pagamentos</Title>
</head>
<body>
	...
	<div class="section">
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center">
					<h3 class="tt_menu">&gt;&gt; Pagamentos - Consulta Todos
						Pagamentos &lt;&lt;</h3>
				</div>
			</div>
					...
					<div class="col-md-12 text-center">
						...
						<table align="center" border="1">
							...
							<c:forEach var="row" items="${pagamentos}">
								<tr align="center">
									<td><c:out value="${row.id.cpf}"></c:out></td>
									<td><c:out value="${row.id.cdCurso}"></c:out></td>
									<td><c:out value="${row.dataInscricao}"></c:out></td>
